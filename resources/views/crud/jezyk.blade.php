		...
		<div class="starter-template">
			...
			<div class="container">
				...
				<ul class="nav nav-tabs">
					...
					<li class="nav-item">
						<a class="nav-link active" href="/projekt/public/adminPanel/jezyki">Języki</a>
					</li>
					<li class="nav-item">
		...
		<div class="table-responsive">
			<table class="table">
				...
				@foreach ($jezyki as $jezyk)
					<tr>
						<td>
							<a style="text-decoration:none;" href="/projekt/public/adminPanel/jezyki/delete/{{$jezyk->id}}" title="Usuń rekord" data-toggle="popover" data-trigger="hover" data-content="Ten rekord będzie usunięty z bazy danych!">
