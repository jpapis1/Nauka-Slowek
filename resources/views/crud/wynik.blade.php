		...
		<div class="starter-template">
			...
			<div class="container">
				...
				<ul class="nav nav-tabs">
					...
					<li class="nav-item">
						<a class="nav-link active" href="/projekt/public/adminPanel/wyniki">Wyniki</a>
					</li>
					<li class="nav-item">
		...
		<div class="table-responsive">
			<table class="table">
				...
				@foreach ($wyniki as $wynik)
					<tr>
						<td>
							<a style="text-decoration:none;" href="/projekt/public/adminPanel/wyniki/delete/{{$wynik->id}}" title="Usuń rekord" data-toggle="popover" data-trigger="hover" data-content="Ten rekord będzie usunięty z bazy danych!">
