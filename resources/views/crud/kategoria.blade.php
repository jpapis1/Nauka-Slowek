...
@section('content')
	...
	<main role="main" class="container">
		...
		<div class="starter-template">
			...
			<div class="container">
				...
				<ul class="nav nav-tabs">
					...
					<li class="nav-item">
						<a class="nav-link active" href="/projekt/public/adminPanel/kategorie">Kategorie</a>
					</li>
					<li class="nav-item">
		...
		<div class="table-responsive">
			<table class="table">
				...
				@foreach ($kategorie as $kategoria)
					<tr>
						<td>
							<a style="text-decoration:none;" href="/projekt/public/adminPanel/kategorie/delete/{{$kategoria->id}}" title="Usuń rekord" data-toggle="popover" data-trigger="hover" data-content="Ten rekord będzie usunięty z bazy danych!">
								<i class="fa fa-times-circle" aria-hidden="true"></i>
							</a>
							<a style="text-decoration:none;" href="/projekt/public/adminPanel/kategorie/edit/{{$kategoria->id}}" title="Edytuj rekord" data-toggle="popover" data-trigger="hover" data-content="Przejdź do strony dzięki której zmodyfikujesz dany rekord.">
				...
				@endforeach
				{!! Form::open(array('route' => 'createKategoria', 'method' => 'POST')) !!}
				<tr>
					<td></td>
		...
		<p></p>
		{!! Form::submit("Utwórz kategorię", array('class' => "btn btn-outline-success",'role' => "btn btn-success")) !!}
		{!! Form::close() !!}
		<p></p>
