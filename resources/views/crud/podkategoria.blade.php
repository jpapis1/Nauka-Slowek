...
@section('content')
	...
	<main role="main" class="container">
		...
		<div class="starter-template">
			...
			<div class="container">
				...
				<ul class="nav nav-tabs">
					...
					<li class="nav-item">
						<a class="nav-link active" href="/projekt/public/adminPanel/podkategorie">Podkategorie</a>
					</li>
					<li class="nav-item">
		...
		<div class="table-responsive">
			<table class="table">
				...
				@foreach ($podkategorie as $podkategoria)
					<tr>
						<td>
							<a style="text-decoration:none;" href="/projekt/public/adminPanel/podkategorie/delete/{{$podkategoria->id}}" title="Usuń rekord" data-toggle="popover" data-trigger="hover" data-content="Ten rekord będzie usunięty z bazy danych!">
								<i class="fa fa-times-circle" aria-hidden="true"></i>
							</a>
							<a style="text-decoration:none;" href="/projekt/public/adminPanel/podkategorie/edit/{{$podkategoria->id}}" title="Edytuj rekord" data-toggle="popover" data-trigger="hover" data-content="Przejdź do strony dzięki której zmodyfikujesz dany rekord.">
								<i class="fa fa-edit" aria-hidden="true"></i>
							</a>

						</td>
						<td>{{$podkategoria->nazwa}}</td>
						<td>{{$podkategoria->opis}}</td>
						<td>
							@foreach ($podkategoria->kategoria_id as $kategoria)
								{{ $kategoria->nazwa}}
							@endforeach
				...
				@endforeach
				{!! Form::open(array('route' => 'createPodkategoria', 'method' => 'POST')) !!}
				<tr>
					<td></td>
					<td><input type="text" name="nazwa" id="inputText" class="form-control" placeholder="Nazwa" required autofocus></td>
					<td><input type="text" name="opis" id="inputText" class="form-control" placeholder="Opis" required autofocus></td>
					<td>
		...
		<p></p>
		{!! Form::submit("Utwórz podkategorię", array('class' => "btn btn-outline-success",'role' => "btn btn-success")) !!}
		{!! Form::close() !!}
		<p></p>
